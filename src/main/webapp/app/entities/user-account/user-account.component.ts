...
export class UserAccountComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.userAccountService
      ...
      .subscribe(
        (res: HttpResponse<IUserAccount[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInUserAccounts(): void {
    this.eventSubscriber = this.eventManager.subscribe('userAccountListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IUserAccount[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
