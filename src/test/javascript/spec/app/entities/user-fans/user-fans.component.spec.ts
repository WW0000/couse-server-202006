...
import { UserFansComponent } from 'app/entities/user-fans/user-fans.component';
...
describe('Component Tests', () => {
  describe('UserFans Management Component', () => {
    let comp: UserFansComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(UserFansComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.userFans && comp.userFans[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
