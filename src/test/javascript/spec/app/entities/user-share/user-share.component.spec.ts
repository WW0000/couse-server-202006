...
import { UserShareComponent } from 'app/entities/user-share/user-share.component';
...
describe('Component Tests', () => {
  describe('UserShare Management Component', () => {
    let comp: UserShareComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(UserShareComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.userShares && comp.userShares[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
