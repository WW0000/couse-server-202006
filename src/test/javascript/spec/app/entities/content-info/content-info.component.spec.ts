...
import { ContentInfoComponent } from 'app/entities/content-info/content-info.component';
...
describe('Component Tests', () => {
  describe('ContentInfo Management Component', () => {
    let comp: ContentInfoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ContentInfoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.contentInfos && comp.contentInfos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
